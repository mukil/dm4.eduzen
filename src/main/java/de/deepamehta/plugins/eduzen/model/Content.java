...
import static de.deepamehta.plugins.eduzen.model.ContentTopic.*;
 ...
 */
public class Content implements JSONEnabled {
     ...
     */
    public Content(long id, DeepaMehtaService dms, ClientState clientState) {
     ...
     */
    public Content(ContentTopic model, DeepaMehtaService dms, ClientState clientState) {
